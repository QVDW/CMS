    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.error || "Failed to create hosting");
            }

            router.push("/adm/hostings");
        } catch (err: any) {
            ...
            <div className="flex column">
                ...
                <div id="main-content">
                    <div className="adm-form-header">
                        ...
                        <h1 className="adm-title">Add New Hosting</h1>
                    </div>
                        ...
                        <div className="adm-form-section">
                            ...
                            <div className="adm-form-group">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="adm-form-control"
                                    placeholder="SSH connection password"
                                />
                            </div>
                        </div>
